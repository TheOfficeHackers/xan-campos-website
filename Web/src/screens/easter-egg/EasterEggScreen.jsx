  ...
  return (
    <div className="easter-screen pt-5">
      <div className="container pb-5">
        ...
        <br></br>
        <h4>
          En abril de 2022, un grupo de intrépid@s fans de Agoney decide
         ...
         <h4>Tras seis árduos meses de rellenar encuestas hasta el vómito y algún
          que otro lab empezado, est@s talentos@s hackers se disponen a
          ...
          se l@s encuentra, quizá pueda contratarl@s... Ell@s son los...
        </h4>
